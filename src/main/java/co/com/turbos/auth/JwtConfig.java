...
public class JwtConfig {
	...
	public static final String CLIENT_CONFIG = "turb0s/tr4ck";
	
	public static final String CLIENT_SECRET = "/Turb0ckTr4cks2o2A/";
	
	public static final String CLIENT_GRANT = "password";
	
	public static final String CLIENT_TYPE = "refresh_token";
